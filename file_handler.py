...
def extract_text_from_pdf(file_bytes):
    try:
        ...
        st.error(
            "Error extracting text from PDF. Please check the file format or content."
        )
        return ""
...
def extract_text_from_docx(file_bytes):
    try:
        ...
        st.error(
            "Error extracting text from DOCX. Please check the file format or content."
        )
        return ""
...
def extract_text(uploaded_file):
    ...
    if not extracted_text.strip():
        ...
        st.warning(
            "The file does not contain any extractable text. Please check the file content."
        )
        return ""
    else:
